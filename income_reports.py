        ...
        if messages:  # If there are any messages, iterate else sys.exit()
            ...
            for msg in messages:  # main iteration
                ...
                try:
                    ...
                    if (
                        "Income Report#" in subject
                    ):  # only keep going if it's an Icome Report otherwise go to beginning of loop to next message
                        pass
                    else:
                        continue

                    # Remove what we don't need from the Subject
                    subject = subject.replace("Income Report#", "")
                    ...
                    gsheets_range = (
                        f"{gsheets_tab}!A{first_empty_row}:D{first_empty_row}"
                    )
