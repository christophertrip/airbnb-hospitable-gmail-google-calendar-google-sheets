        ...
        if cleaning_form_sheet_response["values"]:
            ...
            for _value in cleaning_form_sheet_response["values"]:
                if _value[2] == "" and _value[3] and len(_value) == 7:
                    ...
                    weekly_total = f"{int(_value[3]) + int(_value[5])}"
                    ...
                    gsheets_range = f"Cleaning Service Form!I{current_row_number}:J{current_row_number}"
...
# print(f"Water Service test {datetime.now()}")
# At 1:10am on Saturday
# 10 1 * * Sat
